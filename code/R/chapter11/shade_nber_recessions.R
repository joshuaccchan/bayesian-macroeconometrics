...
#
# Base R graphics have no z-ordering, so unlike the MATLAB version (which pushes
# the patches to the bottom with uistack) this must be called on an empty plot
# frame BEFORE the series are drawn.
#
# Inputs:
